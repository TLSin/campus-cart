...
export default function Login() {
    ...
    return (
        <>
            ...
            {/*Login whole screen*/}
            <div className="bg-[#DEC2CB] h-screen w-screen">

                {/*Login-card*/}
                <div className="absolute w-[45rem] h-[50rem] rounded-3xl inset-y-[3rem] right-[10rem] shadow-xl shadow-black/50 bg-[#92A8D1] overflow-hidden">
                    ...
                    <div className="absolute w-full h-full">
                        ...
                        <div className="flex justify-center items-center mt-[2rem]">
                            ...
                            <a href="Signup" className="ml-2 text-[#FFFFFF] text-sm font-bold hover:underline">Sign Up</a>
                        </div>
                    </div>
