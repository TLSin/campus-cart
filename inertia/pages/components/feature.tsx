    ...
    return (
        <>
            <div className="backdrop-blur-sm">
                ...
                <div className="carousel w-full flex align-items-center">
                    {/* Item list of products*/}
                    <div className="carousel-item relative w-full shadow-lg rounded-lg bg-white grid grid-cols-6 gap-4 align-items-center">
                        {paginated.length > 0 ? (
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <div className="flex flex-row justify-between">
                                            <div className="flex flex-col h-[3rem]">
                                                <span className="text-[0.8rem] font-bold text-black h-[3rem]">{product.productName}</span>
                                            </div>
                                            <span className="font-bold text-red-600 text-[1rem]">{product.productPrice}</span>
                                        </div>
                        ...
                        <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between mt-[1rem] z-2">
                            <button
                                className="btn btn-circle text-black hover:cursor=pointer"
