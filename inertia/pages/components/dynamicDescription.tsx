                        ...
                        <div className="col-2 align-center justify-between col-span-2 pt-[1rem]">
                            {productVariants.map((variant) => (
                                <button
                                    ...
                                    className={`btn text-black text=[1rem] mr-[0.2rem] h-[2rem] px-2 py-2 border rounded-none mb-[0.5rem] active:text-white focus:text-white 
                                        ${selectedProductId === variant.productId ? 'bg-[#44506D] text-white' : 'bg-white text-gray-700 hover:bg-gray-100 border-gray-300'}`}
