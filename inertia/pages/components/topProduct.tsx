        ...
        <>
            <div className="backdrop-blur-sm">
                ...
                <div className="carousel w-full flex">
                    {/* Item list 1 */}
                    <div id="slide1.1" className="carousel-item relative w-full shadow-lg rounded-lg bg-white grid grid-cols-6 gap-4 justify-items-center">
                        {/* Item Card 1 */}
                    ...
                    {/* Item list 2 */}
                    <div id="slide2.1" className="carousel-item relative w-full  shadow-lg rounded-lg bg-white grid grid-cols-6 gap-4 justify-items-center">
                        {/* Item Card 1 */}
                        <div className="2xl:w-[20rem] 2xl:h-[23.75rem] xl:w-[16.25rem] xl:h-[20rem] lg:w-[12.50rem] lg:h-[16.25rem] md:w-[15rem] md:h[18.75rem] w-[12.5rem] h-[16.25rem] bg-gray-50 p-3 flex flex-col gap-1 col-span-1">
                            <div className="duration-500 contrast-50 h-48 bg-gradient-to-bl from-black via-orange-900 to-indigo-600  hover:contrast-100"></div>
                            <div className="flex flex-col gap-4">
                        ...
                        <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between mt-[1rem]">
                            <a href="#slide1.1" className="btn btn-circle">❮</a>
                            <a href="#slide3.1" className="btn btn-circle">❯</a>
                        </div>
                    </div>
                    {/* Item list 3 */}
                    <div id="slide3.1" className="carousel-item relative w-full  shadow-lg rounded-lg bg-white grid grid-cols-6 gap-4 justify-items-center">
                        {/* Item Card 1 */}
                        <div className="2xl:w-[20rem] 2xl:h-[23.75rem] xl:w-[16.25rem] xl:h-[20rem] lg:w-[12.50rem] lg:h-[16.25rem] md:w-[15rem] md:h[18.75rem] w-[12.5rem] h-[16.25rem] bg-gray-50 p-3 flex flex-col gap-1 col-span-1">
                            <div className="duration-500 contrast-50 h-48 bg-gradient-to-bl from-black via-orange-900 to-indigo-600  hover:contrast-100"></div>
                            <div className="flex flex-col gap-4">
                    ...
                    {/* Item list 4 */}
                    <div id="slide4.1" className="carousel-item relative w-full  shadow-lg rounded-lg bg-white grid grid-cols-6 gap-4 justify-items-center">
                        {/* Item Card 1 */}
                        <div className="2xl:w-[20rem] 2xl:h-[23.75rem] xl:w-[16.25rem] xl:h-[20rem] lg:w-[12.50rem] lg:h-[16.25rem] md:w-[15rem] md:h[18.75rem] w-[12.5rem] h-[16.25rem] bg-gray-50 p-3 flex flex-col gap-1 col-span-1">
                            <div className="duration-500 contrast-50 h-48 bg-gradient-to-bl from-black via-orange-900 to-indigo-600  hover:contrast-100"></div>
                            <div className="flex flex-col gap-4">
